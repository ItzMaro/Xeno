...
namespace XenoUI
{
    public partial class ClientsWindow : Window
    {
        ...
        private static int GetClientId(string? content) => content != null ? int.Parse(content.Split(", PID: ")[1]) : 0;
        private static string GetClientName(string? content) => content != null ? content.Split(", PID: ")[0].Trim() : string.Empty;
